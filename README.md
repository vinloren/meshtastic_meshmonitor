...
il 17 Settembre aggiunto supporto a ricezione mail per invio del testo su ch0. Leggere documento in ./Doc/Gestione_Mail_in_meshmonitor.pdf
...
il 19 Settembre aggiunto supporto affinché mesh_controller una volta ricevuto un messaggio su ch0 contenente la parola Alert lo invii via Gmail al destinatario configurato nel file .env da dove prende anche i riferimenti di mittente su Gmail e di password app Gmail. E' questo un modo per ricevere allarmi / informazioni sulla propria mail ricevuti via rete meshtastic.
